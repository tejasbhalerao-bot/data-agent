-- 1.6 Base Extract v2: PBA's TAT estimate for Internal courier (different-courier cohort)
-- Adds allocation_created_at to support pre/post cutoff analysis (1.7).
-- All other columns unchanged from v1.
